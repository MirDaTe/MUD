...
def seed():
    ...
    # ── NPCs ──
    npcs = [
        NPC(id=1, name="주점 주인", dialogue="[주인장] 어서 오시오. 방 하나와 술 한잔? 아니면... 정보가 필요하신가? 이 동네는 돈 되는 얘기가 많지.", is_hostile=False),
        NPC(id=2, name="청람문지기", dialogue="[문지기] 청람검문에 무슨 일이시오? 검을 배우러 왔다면 시험부터 치르시오. 사절이라면... 용건을 말씀하시지.", is_hostile=False),
        NPC(id=3, name="의문의검객", dialogue="[의문의 검객] ...자네, 낙화검결에 대해 뭔가 알고 있나? 모른다면 상관없네. 하지만 안다면... 조심하게. 귀화천의 눈은 어디에나 있으니.", is_hostile=False),
    ]
    db.add_all(npcs)
    db.flush()
    ...
    # ── Monsters ──
    monsters = [
        Monster(id=1, name="산적패잔병", max_hp=40, hp=40, attack=8, defense=3, speed=10, exp_reward=25,
        ...
        Monster(id=2, name="검은이리", max_hp=30, hp=30, attack=12, defense=1, speed=14, exp_reward=30,
        ...
        Monster(id=3, name="의문의암살자", max_hp=60, hp=60, attack=15, defense=6, speed=12, exp_reward=80,
        ...
        Monster(id=4, name="청람훈련인형", max_hp=80, hp=80, attack=6, defense=8, speed=5, exp_reward=15,
        ...
        Monster(id=5, name="혈랑객", max_hp=70, hp=70, attack=14, defense=5, speed=11, exp_reward=100,
