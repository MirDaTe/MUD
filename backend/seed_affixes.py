...
def seed_affixes():
    ...
    affixes = [
        ...
        {"id": 41, "code": "AFF_SUFFIX_MERCHANT", "name": "[행상인]", "affix_type": "suffix", "tier": 1,
         "apply_to": ["weapon", "armor"], "stats": {"gold_reward": 0.10}, "description": "행상인의 물건"},
        {"id": 42, "code": "AFF_SUFFIX_ORPHAN", "name": "[고아]", "affix_type": "suffix", "tier": 1,
         "apply_to": ["weapon", "armor"], "stats": {"charm": 2}, "description": "고아의 유품"},

        # 등급2
        {"id": 43, "code": "AFF_SUFFIX_WARRIOR", "name": "[무인]", "affix_type": "suffix", "tier": 2,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 3, "defense": 2}, "description": "무인의 혼이 담긴"},
        {"id": 44, "code": "AFF_SUFFIX_STUDENT", "name": "[수련생]", "affix_type": "suffix", "tier": 2,
         "apply_to": ["weapon", "armor"], "stats": {"hp": 10, "mp": 5}, "description": "수련생의 노력"},
        {"id": 45, "code": "AFF_SUFFIX_WANDERER", "name": "[방랑자]", "affix_type": "suffix", "tier": 2,
         "apply_to": ["weapon", "armor"], "stats": {"speed": 4}, "description": "방랑자의 벗"},
        {"id": 46, "code": "AFF_SUFFIX_HUNTER", "name": "[사냥꾼]", "affix_type": "suffix", "tier": 2,
         "apply_to": ["weapon"], "stats": {"attack": 4}, "description": "사냥꾼의 도구"},

        # 등급3
        {"id": 47, "code": "AFF_SUFFIX_ELITE", "name": "[정예]", "affix_type": "suffix", "tier": 3,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 6, "defense": 4}, "description": "정예의 장비"},
        {"id": 48, "code": "AFF_SUFFIX_HERO", "name": "[용사]", "affix_type": "suffix", "tier": 3,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 8, "hp": 20}, "description": "용사의 유산"},
        {"id": 49, "code": "AFF_SUFFIX_SAGE", "name": "[현자]", "affix_type": "suffix", "tier": 3,
         "apply_to": ["weapon", "armor"], "stats": {"mp": 15, "insight": 3}, "description": "현자의 지혜"},
        {"id": 50, "code": "AFF_SUFFIX_ASSASSIN", "name": "[암살자]", "affix_type": "suffix", "tier": 3,
         "apply_to": ["weapon"], "stats": {"attack": 8, "speed": 6, "defense": -3}, "description": "암살자의 도구"},
        {"id": 51, "code": "AFF_SUFFIX_GUARDIAN", "name": "[수호자]", "affix_type": "suffix", "tier": 3,
         "apply_to": ["weapon", "armor"], "stats": {"defense": 10, "hp": 25}, "description": "수호자의 의지"},

        # 등급4
        {"id": 52, "code": "AFF_SUFFIX_MASTER", "name": "[고수]", "affix_type": "suffix", "tier": 4,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 12, "defense": 8, "speed": 3}, "description": "고수의 혼"},
        {"id": 53, "code": "AFF_SUFFIX_SWORD_IMMORTAL", "name": "[검선]", "affix_type": "suffix", "tier": 4,
         "apply_to": ["weapon"], "stats": {"attack": 18, "speed": 5, "crit_rate": 0.03}, "description": "검선의 검"},
        {"id": 54, "code": "AFF_SUFFIX_SLAYER", "name": "[살수]", "affix_type": "suffix", "tier": 4,
         "apply_to": ["weapon"], "stats": {"attack": 16, "speed": 8, "crit_rate": 0.04}, "description": "살수의 칼날"},
        {"id": 55, "code": "AFF_SUFFIX_LORD", "name": "[군주]", "affix_type": "suffix", "tier": 4,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 15, "defense": 10, "hp": 30}, "description": "군주의 위엄"},

        # 등급5
        {"id": 56, "code": "AFF_SUFFIX_BEST_UNDER_HEAVEN", "name": "[천하제일]", "affix_type": "suffix", "tier": 5,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 25, "defense": 15, "speed": 5}, "description": "천하제일의 증표"},
        {"id": 57, "code": "AFF_SUFFIX_MURIM_SUPREME", "name": "[무림지존]", "affix_type": "suffix", "tier": 5,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 30, "crit_rate": 0.05, "hp": 50}, "description": "무림지존의 상징"},
        {"id": 58, "code": "AFF_SUFFIX_IMMORTAL_BEING", "name": "[신선]", "affix_type": "suffix", "tier": 5,
         "apply_to": ["weapon", "armor"], "stats": {"attack": 20, "defense": 12, "mp": 40, "speed": 6}, "description": "신선의 도구"},
        {"id": 59, "code": "AFF_SUFFIX_DEMON_KING", "name": "[마왕]", "affix_type": "suffix", "tier": 5,
